...
export default function PortfolioPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/#services" className="text-slate-700 hover:text-teal-600 font-medium transition-colors">
                Services
              </Link>
              <Link href="/portfolio" className="text-teal-600 font-medium">
                Portfolio
              </Link>
  ...
  See our contributions to <strong>Amazon re:MARS</strong>, focusing on{" "}
  <a 
    href="https://www.youtube.com/playlist?list=PL2yQDdvlhXf8k8ZCMKx7WO97Yef6NmFPf" 
    target="_blank" 
    rel="noopener noreferrer"
    className="text-blue-200 hover:text-white underline hover:no-underline transition-colors"
  >
    Machine Learning
  </a>, {" "}
  <a 
    href="https://www.youtube.com/playlist?list=PL2yQDdvlhXf8OyFTBht-TMns7fucns9fN" 
    target="_blank" 
    rel="noopener noreferrer"
    className="text-blue-200 hover:text-white underline hover:no-underline transition-colors"
  >
  ...
  <a 
    href="https://www.youtube.com/playlist?list=PL2yQDdvlhXf8odsYumzdGDRQJbYHwGc3o" 
    target="_blank" 
    rel="noopener noreferrer"
    className="text-blue-200 hover:text-white underline hover:no-underline transition-colors"
  >
  ...
  <a 
    href="https://www.youtube.com/playlist?list=PL2yQDdvlhXf_e2MHyMi7Mt42ID7coGqL3" 
    target="_blank" 
    rel="noopener noreferrer"
    className="text-blue-200 hover:text-white underline hover:no-underline transition-colors"
  >
